...
# ----------------------------------------
# If ram_2port_512x32 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2017.11.29.09:25:43
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ram_2port_512x32"
}
...
ensure_lib                                ./libraries/ram_2port_512x32_ram_2port_161/
vmap       ram_2port_512x32_ram_2port_161 ./libraries/ram_2port_512x32_ram_2port_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_161/sim/ram_2port_512x32_ram_2port_161_wdhffea.v" -work ram_2port_512x32_ram_2port_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2port_512x32.v"                                                                                
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ram_2port_512x32_ram_2port_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ram_2port_512x32_ram_2port_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
