...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/fp_add_altera_fp_functions_161_vikdi5i.vhd" -work fp_add_altera_fp_functions_161
