...
mkdir -p ./libraries/Rom_Check2_rom_1port_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_161/sim/Rom_Check2_rom_1port_161_6cvufhq.v" -work Rom_Check2_rom_1port_161 -cdslib ./cds_libs/Rom_Check2_rom_1port_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Rom_Check2.v"                                                                                                                              
fi
