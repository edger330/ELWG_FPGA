...
# ----------------------------------------
# If Rom_Check0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2018.01.18.11:25:11
...
ensure_lib                          ./libraries/Rom_Check0_rom_1port_161/
vmap       Rom_Check0_rom_1port_161 ./libraries/Rom_Check0_rom_1port_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_161/sim/Rom_Check0_rom_1port_161_yfdjnlq.v" -work Rom_Check0_rom_1port_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Rom_Check0.v"                                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L Rom_Check0_rom_1port_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L Rom_Check0_rom_1port_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
