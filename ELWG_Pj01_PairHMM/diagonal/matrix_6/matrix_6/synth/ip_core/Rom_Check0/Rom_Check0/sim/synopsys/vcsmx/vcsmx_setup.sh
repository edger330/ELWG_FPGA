...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_161/sim/Rom_Check0_rom_1port_161_yfdjnlq.v" -work Rom_Check0_rom_1port_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Rom_Check0.v"                                                                          
fi
