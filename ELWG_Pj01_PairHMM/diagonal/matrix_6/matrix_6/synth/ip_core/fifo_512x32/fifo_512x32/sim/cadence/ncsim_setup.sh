...
mkdir -p ./libraries/fifo_512x32_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_512x32_fifo_161_6hroaea.v" -work fifo_512x32_fifo_161 -cdslib ./cds_libs/fifo_512x32_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_512x32.v"                                                                                                            
fi
