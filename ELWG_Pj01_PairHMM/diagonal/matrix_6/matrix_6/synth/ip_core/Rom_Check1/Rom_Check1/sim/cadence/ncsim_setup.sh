...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_161/sim/Rom_Check1_rom_1port_161_rt54boq.v" -work Rom_Check1_rom_1port_161 -cdslib ./cds_libs/Rom_Check1_rom_1port_161.cds.lib
