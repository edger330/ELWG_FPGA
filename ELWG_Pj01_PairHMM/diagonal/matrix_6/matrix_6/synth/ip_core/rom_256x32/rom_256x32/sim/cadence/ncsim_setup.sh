...
mkdir -p ./libraries/rom_256x32_rom_1port_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_161/sim/rom_256x32_rom_1port_161_2qxtcda.v" -work rom_256x32_rom_1port_161 -cdslib ./cds_libs/rom_256x32_rom_1port_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rom_256x32.v"                                                                                                                              
fi
