...
input  wire  [31:0] M_i_j     ;
input  wire  [31:0] X_i_j     ;
input  wire  [31:0] Y_i_j     ;

input  wire  [31:0] p_mx     ;
input  wire  [31:0] p_my     ;
input  wire  [31:0] p_mm     ;
...
assign X = (mode)? X_mode1 : 32'b0;
assign Y = (mode)? Y_mode1 : Y_Init;
assign M = (mode)? M_mode1 : 32'b0;

assign X_mode1 = (Init_in_5)? X_i_j : 32'b0;
assign Y_mode1 = (Init_in_5)? Y_i_j : 32'b0;
assign M_mode1 = (Init_in_5)? M_i_j : 32'b0;
...
begin 
	if (!sys_rst_n) begin 
		SUM_2 <= 32'd0;
	end else if (SUM_start_reg_1) begin 
		SUM_2 <= 32'd0;
	end else begin 
		SUM_2 <= SUM_1;
	end
