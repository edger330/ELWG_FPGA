...
input wire  [31:0] M_write           ;
input wire  [31:0] X_write           ;
input wire         vld               ;
input wire  		 init_out 		   ;
//outpu;
...
assign pkt_receive_enable = (!busy);
...
// 	if (!sys_rst_n) begin
// 		get_R_done <= 1'b0;
// 	end else if ((info_cnt == 3'd5) & (read_len_mv_2 == 6'd0)) begin 
// 		get_R_done <= 1'b1;
...
// 	if (!sys_rst_n) begin
// 		get_H_done <= 1'b0;
// 	end else if (get_R_done & (hap_len_mv_2 == 7'd0)) begin 
// 		get_H_done <= 1'b1;
...
// 	if (!sys_rst_n) begin
// 		get_qidc_done <= 1'b0;
// 	end else if (get_H_done & (read_len == 1)) begin 
// 		get_qidc_done <= 1'b1;
