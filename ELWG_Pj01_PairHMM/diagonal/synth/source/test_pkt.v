...
begin
  if(!sys_rst_n)begin	
    f0_get_data_ren <= 1'b0;
    f1_get_data_ren <= 1'b0;
    f2_get_data_ren <= 1'b0;
    f3_get_data_ren <= 1'b0;            
  end else begin
    f0_get_data_ren <= get_data_ren;
    f1_get_data_ren <= f0_get_data_ren;
    f2_get_data_ren <= f1_get_data_ren;
    f3_get_data_ren <= f2_get_data_ren;     
  end     
end
...
begin
  if(!sys_rst_n)begin	
    pcie_ram_ren_reg <= 1'b0;
  end else if(counter1 == 8'd1) begin
    pcie_ram_ren_reg <= 1'b1;  
...
begin
  if(!sys_rst_n)begin	
    pcie_ram_raddr_reg <= 16'd0;
  end else if(counter1 == 8'd1) begin
    pcie_ram_raddr_reg <= 16'd0;  
  end else if(counter2 == 8'd1) begin
    pcie_ram_raddr_reg <= pcie_ram_raddr_reg + 1; 		
  end else if(get_data_ren)	begin
    pcie_ram_raddr_reg <= pcie_ram_raddr_reg + 1;    	
  end 	
end
