...
mkdir -p ./libraries/ram_9600x128_ram_2port_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_161/sim/ram_9600x128_ram_2port_161_hoafeji.v" -work ram_9600x128_ram_2port_161 -cdslib ./cds_libs/ram_9600x128_ram_2port_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_9600x128.v"                                                                                                                                  
fi
