...
# ----------------------------------------
# If rom_256x32 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2017.12.05.19:52:34
...
ensure_lib                          ./libraries/rom_256x32_rom_1port_161/
vmap       rom_256x32_rom_1port_161 ./libraries/rom_256x32_rom_1port_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_161/sim/rom_256x32_rom_1port_161_n3fz64y.v" -work rom_256x32_rom_1port_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rom_256x32.v"                                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L rom_256x32_rom_1port_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L rom_256x32_rom_1port_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
