...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_161/sim/rom_256x32_rom_1port_161_n3fz64y.v" -work rom_256x32_rom_1port_161 -cdslib ./cds_libs/rom_256x32_rom_1port_161.cds.lib
