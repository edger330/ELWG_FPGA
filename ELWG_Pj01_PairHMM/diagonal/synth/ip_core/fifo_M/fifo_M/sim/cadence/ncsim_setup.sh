...
mkdir -p ./libraries/fifo_M_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_M_fifo_161_skz73ra.v" -work fifo_M_fifo_161 -cdslib ./cds_libs/fifo_M_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_M.v"                                                                                                  
fi
