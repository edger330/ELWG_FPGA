...
mkdir -p ./libraries/diagonal_altera_fp_functions_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library_package.vhd"                    -work diagonal_altera_fp_functions_161 -cdslib ./cds_libs/diagonal_altera_fp_functions_161.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_161/sim/dspba_library.vhd"                            -work diagonal_altera_fp_functions_161 -cdslib ./cds_libs/diagonal_altera_fp_functions_161.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_161/sim/diagonal_altera_fp_functions_161_4gfcm3q.vhd" -work diagonal_altera_fp_functions_161 -cdslib ./cds_libs/diagonal_altera_fp_functions_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/diagonal.v"                                                                                                                                                                    
fi
