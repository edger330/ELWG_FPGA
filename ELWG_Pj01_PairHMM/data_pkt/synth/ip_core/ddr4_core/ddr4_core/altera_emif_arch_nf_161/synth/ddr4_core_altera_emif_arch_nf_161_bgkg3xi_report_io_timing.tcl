...
source "$script_dir/ddr4_core_altera_emif_arch_nf_161_bgkg3xi_report_timing_core.tcl"


if [ info exists ddr_db ] {
   unset ddr_db
}
ddr4_core_altera_emif_arch_nf_161_bgkg3xi_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_ddr4_core_altera_emif_arch_nf_161_bgkg3xi_corename}"
   } else {
      set fbasename "${::GLOBAL_ddr4_core_altera_emif_arch_nf_161_bgkg3xi_corename}_${inst_id}"
   }
   ...
   ddr4_core_altera_emif_arch_nf_161_bgkg3xi_perform_read_capture_analysis $opcname $inst pins var summary
   
   #######################################
   # Write Analysis

   ddr4_core_altera_emif_arch_nf_161_bgkg3xi_perform_write_launch_analysis $opcname $inst pins var summary

   #######################################
   # Address/command Analyses

   ddr4_core_altera_emif_arch_nf_161_bgkg3xi_perform_ac_analysis  $opcname $inst pins var summary

   #######################################
   # DQS Gating Analysis

   ddr4_core_altera_emif_arch_nf_161_bgkg3xi_perform_dqs_gating_analysis   $opcname $inst pins var summary

   #######################################
   # Write Levelling Analysis 
   
   ddr4_core_altera_emif_arch_nf_161_bgkg3xi_perform_write_levelling_analysis $opcname $inst pins var summary

   #######################################
   # PHY Analyses
   
   ddr4_core_altera_emif_arch_nf_161_bgkg3xi_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance   

   set summary [lsort -command ddr4_core_altera_emif_arch_nf_161_bgkg3xi_sort_proc $summary]
   ...
   puts $f "Core: ${::GLOBAL_ddr4_core_altera_emif_arch_nf_161_bgkg3xi_corename} - Instance: $inst"
   puts $f "Path, Setup Margin, Hold Margin"

   
   post_message -type info "Core: ${::GLOBAL_ddr4_core_altera_emif_arch_nf_161_bgkg3xi_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ ddr4_core_altera_emif_arch_nf_161_bgkg3xi_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ ddr4_core_altera_emif_arch_nf_161_bgkg3xi_round_3dp $hold]
      }
