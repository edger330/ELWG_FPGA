...
---------------------
 ...
 17. Reset interface for the core master logic that interacts with the sequencer CPU
 18. Clock interface for the core master logic that interacts with the sequencer CPU
 19. Reset interface for the core slave logic that interacts with the sequencer CPU
 20. Clock interface for the core slave logic that interacts with the sequencer CPU
 21. User calibration debug clock domain reset interface
 22. User calibration debug clock interface
 23. Controller Avalon Memory-Mapped interface 0
 24. Calibration debug interface
 25. Interface that allows the EMIF calibration processor to talk to its slave components
 26. Instantiating IP in a simulation project
 27. Full-calibration versus skip-calibration simulation
 28. IP Settings
 29. Configuring the Traffic Generator
...
----------------------------------------------------
   ...
   amm_address_0                  25      input       Address for the read/write request
...
--------------------
   ...
   SYS_INFO_UNIQUE_ID                                : ddr4_core_emif_0
   ...
   PLL_MAPPED_SYS_INFO_DEVICE                        : 10AX115S2F45I1SG
   ...
   PLL_EXTRA_CLK_DESIRED_FREQ_MHZ_GUI_0              : 266.66675
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_0               : 266.66675
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_0                   : 266.666
   ...
   PLL_EXTRA_CLK_DESIRED_FREQ_MHZ_GUI_2              : 266.66675
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_GUI_2               : 266.66675
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_2                   : 266.666
   ...
   EX_DESIGN_GUI_DDR4_TARGET_DEV_KIT                 : TARGET_DEV_KIT_A10_GX_FPGA_DDR4
   EX_DESIGN_GUI_DDR4_PREV_PRESET                    : TARGET_DEV_KIT_A10_GX_FPGA_DDR4
