...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_fp_functions_161/sim/fp_sub_altera_fp_functions_161_se3ntfy.vhd" -work fp_sub_altera_fp_functions_161 -cdslib ./cds_libs/fp_sub_altera_fp_functions_161.cds.lib
