...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_161/sim/fp_sub_altera_fp_functions_161_se3ntfy.vhd" -work fp_sub_altera_fp_functions_161
