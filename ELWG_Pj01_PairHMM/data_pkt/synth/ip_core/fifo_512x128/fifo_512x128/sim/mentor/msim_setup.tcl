...
# ----------------------------------------
# ACDS 16.1 196 linux 2017.11.16.14:28:18
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_161/sim/fifo_512x128_fifo_161_2vzxxdi.v" -work fifo_512x128_fifo_161
