...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_512x128_fifo_161_2vzxxdi.v" -work fifo_512x128_fifo_161 -cdslib ./cds_libs/fifo_512x128_fifo_161.cds.lib
