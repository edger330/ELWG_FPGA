...
mkdir -p ./libraries/afifo_8x1_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/afifo_8x1_fifo_161_rgwi5iq.v" -work afifo_8x1_fifo_161 -cdslib ./cds_libs/afifo_8x1_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/afifo_8x1.v"                                                                                                        
fi
