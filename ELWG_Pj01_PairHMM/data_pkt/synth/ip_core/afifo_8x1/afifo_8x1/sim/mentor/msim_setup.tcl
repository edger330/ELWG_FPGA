...
# ----------------------------------------
# If afifo_8x1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2017.07.14.19:26:35
...
ensure_lib                    ./libraries/afifo_8x1_fifo_161/
vmap       afifo_8x1_fifo_161 ./libraries/afifo_8x1_fifo_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_161/sim/afifo_8x1_fifo_161_rgwi5iq.v" -work afifo_8x1_fifo_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/afifo_8x1.v"                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L afifo_8x1_fifo_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L afifo_8x1_fifo_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
