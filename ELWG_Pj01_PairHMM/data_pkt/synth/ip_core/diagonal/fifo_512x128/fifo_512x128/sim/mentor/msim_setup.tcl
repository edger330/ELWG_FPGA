...
# ----------------------------------------
# If fifo_512x128 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2017.08.18.21:24:16
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fifo_512x128"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "E:/altera_161_stan/quartus/"
}
...
ensure_lib                       ./libraries/fifo_512x128_fifo_161/
vmap       fifo_512x128_fifo_161 ./libraries/fifo_512x128_fifo_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_161/sim/fifo_512x128_fifo_161_myzf2pa.v" -work fifo_512x128_fifo_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_512x128.v"                                                             
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_512x128_fifo_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_512x128_fifo_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
