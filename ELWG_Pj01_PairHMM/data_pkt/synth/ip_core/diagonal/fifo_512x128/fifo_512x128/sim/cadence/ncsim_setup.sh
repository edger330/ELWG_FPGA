...
TOP_LEVEL_NAME="fifo_512x128"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="E:/altera_161_stan/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/fifo_512x128_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_512x128_fifo_161_myzf2pa.v" -work fifo_512x128_fifo_161 -cdslib ./cds_libs/fifo_512x128_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_512x128.v"                                                                                                              
fi
