...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_161/sim/ram_2port_512x32_ram_2port_161_wdhffea.v" -work ram_2port_512x32_ram_2port_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2port_512x32.v"                                                                                
fi
