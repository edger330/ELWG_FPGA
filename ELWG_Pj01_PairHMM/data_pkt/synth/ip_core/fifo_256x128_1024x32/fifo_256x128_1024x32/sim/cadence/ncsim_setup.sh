...
TOP_LEVEL_NAME="fifo_256x128_1024x32"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/fifo_256x128_1024x32_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_256x128_1024x32_fifo_161_6ci2erq.v" -work fifo_256x128_1024x32_fifo_161 -cdslib ./cds_libs/fifo_256x128_1024x32_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_256x128_1024x32.v"                                                                                                                              
fi
