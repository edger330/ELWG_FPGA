...
TOP_LEVEL_NAME="ram_2_wrport_2048x32"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/ram_2_wrport_2048x32_ram_2port_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_161/sim/ram_2_wrport_2048x32_ram_2port_161_ywraana.v" -work ram_2_wrport_2048x32_ram_2port_161 -cdslib ./cds_libs/ram_2_wrport_2048x32_ram_2port_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2_wrport_2048x32.v"                                                                                                                                                  
fi
