...
mkdir -p ./libraries/fifo_1024x128_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_1024x128_fifo_161_j6ksvyq.v" -work fifo_1024x128_fifo_161 -cdslib ./cds_libs/fifo_1024x128_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_1024x128.v"                                                                                                                
fi
