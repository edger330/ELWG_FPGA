...
# ----------------------------------------
# If fifo_1024x128 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 linux 2017.11.16.14:57:38
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fifo_1024x128"
}
...
ensure_lib                        ./libraries/fifo_1024x128_fifo_161/
vmap       fifo_1024x128_fifo_161 ./libraries/fifo_1024x128_fifo_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_161/sim/fifo_1024x128_fifo_161_j6ksvyq.v" -work fifo_1024x128_fifo_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_1024x128.v"                                                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_1024x128_fifo_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_1024x128_fifo_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
