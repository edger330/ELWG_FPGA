...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_161/sim/ram_2048x512_8192x128_ram_2port_161_himwlxy.v" -work ram_2048x512_8192x128_ram_2port_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2048x512_8192x128.v"                                                                                     
fi
