...
TOP_LEVEL_NAME="ram_2048x512_8192x128"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/ram_2048x512_8192x128_ram_2port_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_161/sim/ram_2048x512_8192x128_ram_2port_161_himwlxy.v" -work ram_2048x512_8192x128_ram_2port_161 -cdslib ./cds_libs/ram_2048x512_8192x128_ram_2port_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2048x512_8192x128.v"                                                                                                                                                    
fi
