...
# ----------------------------------------
# If pll_125m is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 linux 2017.11.22.17:38:33
...
ensure_lib                           ./libraries/pll_125m_altera_iopll_161/
vmap       pll_125m_altera_iopll_161 ./libraries/pll_125m_altera_iopll_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_161/sim/pll_125m_altera_iopll_161_5zboggi.vo" -work pll_125m_altera_iopll_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_125m.v"                                                                                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L pll_125m_altera_iopll_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L pll_125m_altera_iopll_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
