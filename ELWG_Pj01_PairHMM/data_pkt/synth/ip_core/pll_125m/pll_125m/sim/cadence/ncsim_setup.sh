...
mkdir -p ./libraries/pll_125m_altera_iopll_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_161/sim/pll_125m_altera_iopll_161_5zboggi.vo" -work pll_125m_altera_iopll_161 -cdslib ./cds_libs/pll_125m_altera_iopll_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_125m.v"                                                                                                                                       
fi
