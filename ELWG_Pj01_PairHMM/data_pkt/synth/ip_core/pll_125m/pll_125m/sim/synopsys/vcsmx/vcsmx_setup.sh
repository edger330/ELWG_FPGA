...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_161/sim/pll_125m_altera_iopll_161_5zboggi.vo" -work pll_125m_altera_iopll_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_125m.v"                                                                                  
fi
