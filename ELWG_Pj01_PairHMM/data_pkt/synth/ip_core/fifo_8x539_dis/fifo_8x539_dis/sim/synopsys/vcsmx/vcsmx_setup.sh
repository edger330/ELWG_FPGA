...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_161/sim/fifo_8x539_dis_fifo_161_oakgsvy.v" -work fifo_8x539_dis_fifo_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_8x539_dis.v"                                                               
fi
