...
mkdir -p ./libraries/fifo_8x512_dis_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_8x512_dis_fifo_161_niqd2pa.v" -work fifo_8x512_dis_fifo_161 -cdslib ./cds_libs/fifo_8x512_dis_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_8x512_dis.v"                                                                                                                  
fi
