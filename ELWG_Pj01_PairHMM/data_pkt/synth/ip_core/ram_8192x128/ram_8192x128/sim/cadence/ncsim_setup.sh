...
mkdir -p ./libraries/ram_8192x128_ram_2port_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_161/sim/ram_8192x128_ram_2port_161_rjsjy2a.v" -work ram_8192x128_ram_2port_161 -cdslib ./cds_libs/ram_8192x128_ram_2port_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_8192x128.v"                                                                                                                                  
fi
