...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_161/sim/ram_2_port_1024_32_ram_2port_161_r5t2nhi.v" -work ram_2_port_1024_32_ram_2port_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2_port_1024_32.v"                                                                                  
fi
