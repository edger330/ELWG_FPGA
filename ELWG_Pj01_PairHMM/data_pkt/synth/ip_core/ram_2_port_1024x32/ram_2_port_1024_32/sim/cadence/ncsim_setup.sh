...
TOP_LEVEL_NAME="ram_2_port_1024_32"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/ram_2_port_1024_32_ram_2port_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_161/sim/ram_2_port_1024_32_ram_2port_161_r5t2nhi.v" -work ram_2_port_1024_32_ram_2port_161 -cdslib ./cds_libs/ram_2_port_1024_32_ram_2port_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram_2_port_1024_32.v"                                                                                                                                              
fi
