...
mkdir -p ./libraries/fifo_4096x128_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_4096x128_fifo_161_5kcov5y.v" -work fifo_4096x128_fifo_161 -cdslib ./cds_libs/fifo_4096x128_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_4096x128.v"                                                                                                                
fi
