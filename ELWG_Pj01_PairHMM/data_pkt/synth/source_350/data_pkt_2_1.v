...
begin
  if(!sys_rst_n)begin	
    ...
    pkt_num <=#D {pcie_ram_rdat[7:0],pcie_ram_rdat[15:8],pcie_ram_rdat[23:16],pcie_ram_rdat[31:24]}; 
  end
end
...
begin
  if(!sys_rst_n)begin	
    ...
    data_num <=#D {pcie_ram_rdat[7:0],pcie_ram_rdat[15:8],pcie_ram_rdat[23:16],pcie_ram_rdat[31:24]}; 
  end
end
...
assign    pkt_data = (f2_get_data_ren)? {pcie_ram_rdat[7:0],pcie_ram_rdat[15:8],pcie_ram_rdat[23:16],pcie_ram_rdat[31:24]} : 32'd0;
